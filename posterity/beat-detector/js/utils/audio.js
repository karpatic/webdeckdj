 ...
 */
const updateCrossfader = (leftGainNode, rightGainNode, crossfaderValue) => {
    ...
    const leftGain = Math.cos((normalizedValue * Math.PI) / 2);
    const rightGain = Math.sin((normalizedValue * Math.PI) / 2);
