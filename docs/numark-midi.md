...
| A / B FX Amt | CC 0 / 4 (`0x00/0x04`) absolute | `{ type: 'fxvalue', deck, slot: 0, value }` |
| A / B Select beneath FX Amt | Note 49 / 53 (`0x31/0x35`) | `{ type: 'fxmode', deck, slot: 0 }` |
| A / B Filter Amt | CC 1 / 5 (`0x01/0x05`) absolute | `{ type: 'fxvalue', deck, slot: 1, value }` |
