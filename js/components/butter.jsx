...
const PERFORMANCE_OPTIONS = [
  ...
  ['automaticAnalysis', 'Automatic Degara beat analysis'],
  ...
  return (
    <div>
      <canvas
        ...
        aria-hidden="true"
        style={{
          display: backgroundEnabled && !visualizerError ? "block" : "none",
          position: "fixed",
          top: 0,
          left: 0,
          width: "100vw",
      ...
      >
        ...
        >
          ...
          <p className="small mt-2 mb-2">Disabling analysis terminates active beat workers; completed maps remain cached for the loaded tracks.</p>
